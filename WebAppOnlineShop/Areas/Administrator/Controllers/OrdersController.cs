...
namespace WebAppOnlineShop.Areas.Administrator.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Index(int page = 1, int pageSize = 5)
        {
            ...
            return View(orders.OrderByDescending(x => x.CreatedDate).ToPagedList(page, pageSize));
        }
        ...
        public ActionResult ViewPending(int page = 1, int pageSize = 5)
        {
            var orders = db.Orders.Include(o => o.Customer).Where(x=> x.StatusCategoryID== false);
            return View(orders.OrderByDescending(x => x.CreatedDate).ToPagedList(page, pageSize));
        }
        public ActionResult ViewApproval(int page = 1, int pageSize = 5)
        {
